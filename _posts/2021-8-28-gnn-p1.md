...
如果想进一步理解的话，可以参看论文《[Geometric deep learning: going beyond Euclidean data](https://doi.org/10.1109/MSP.2017.2693418 )》，文中定义了梯度算子和散度算子，并验证了该梯度算子和散度算子是伴随算子，于是可认为该定义是良好的，然后就能推出图 Laplace 算子的表达式。
